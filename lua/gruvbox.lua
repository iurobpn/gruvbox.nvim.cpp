...
local function get_groups()
  ...
  local groups = {
    ...
    GruvboxNeutralRedBold = { fg = colors.neutral_red, bold = config.bold },
    GruvboxGreen = { fg = colors.green },
    GruvboxGreenBold = { fg = colors.green, bold = config.bold },
    GruvboxNeutralGreen = { fg = colors.neutral_green },
    GruvboxNeutralGreenBold = { fg = colors.neutral_reen, bold = config.bold },
    ...
    GruvboxNeutralYellowBold = { fg = colors.neutral_yellow, bold = config.bold },
    GruvboxBlue = { fg = colors.blue },
    GruvboxBlueBold = { fg = colors.blue, bold = config.bold },
    GruvboxNeutralBlue = { fg = colors.neutral_blue },
    GruvboxNeutralBlueBold = { fg = colors.neutral_blue, bold = config.bold },
    ...
    GruvboxNeutralPurpleBold = { fg = colors.neutral_purple, bold = config.bold },
    GruvboxAqua = { fg = colors.aqua },
    GruvboxAquaBold = { fg = colors.aqua, bold = config.bold },
    GruvboxNeutralAqua = { fg = colors.neutral_aqua },
    GruvboxNeutralAquaBold = { fg = colors.neutral_aqua, bold = config.bold },
    ...
    GruvboxNeutralOrangeBold = { fg = colors.neutral_orange, bold = config.bold },
    ...
    iCursor = { link = "Cursor" },
    lCursor = { link = "Cursor" },
    SpecialFunction = { link = "GruvboxOrange" },
    ...
    IdentifierMember = { link = "GruvboxNeutralBlue" },
    identifier = { link = "GruvboxBlue" },
    ...
    ["@attribute"] = { link = "Gruvboxfg2" },
    ["@field"] = { link = "Identifier" },
    ["@property"] = { link = "Identifier" },
    ["@variable"] = { link = "Identifier" },
    ["@variable.builtin"] = { link = "Builtin" },
    ["@variable.member"] = { link = "IdentifierMember" },
    ...
    ["@lsp.typemod.function.classScope"] = { link = "@method" },
  }
